...
Sau khi Framework chạy hoàn tất, hệ thống sẽ tự động sinh ra một file báo cáo có tên `report.json` tại thư mục gốc. File này sẽ chứa bằng chứng (evidence) chỉ đích danh endpoint bị lỗi và mô tả kịch bản thao túng Token thành công.
